...
OUTPUT_DIR     = os.path.join(HERE, "transfer_data")   # JSON results (runtime, not committed)
FIG_DIR        = os.path.join(HERE, "..", "figures")   # paper figures (committed)
...
def main():
    ...
    # --- Figures ---
    print("\n  Generating figures...")
    generate_heatmaps(all_results, args.epsilons, FIG_DIR)
    generate_transfer_ratio_figure(all_results, args.epsilons, FIG_DIR)
