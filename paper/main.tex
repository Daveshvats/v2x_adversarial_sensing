...
enforced in the standard's 1-MHz-RBW mean-power measurement domain): an \emph{emission-mask price of compliance of
...
simulation-only study can make. Absolute calibration and true conformance
