...
Table-7 unwanted-emissions template): an \emph{emission-mask price of compliance of
5--7\,dB} (7.5\,dB under the real template; untargeted) and 16--18\,dB for targeted ``cloaking'' of an active
...
MEAP, PoC $7.5$\,dB (Section~\ref{sec:etsimask}).}
\label{tab:metrics}
\begin{tabular}{llrrr}
\toprule
