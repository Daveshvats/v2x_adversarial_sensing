...
the WiFi class with real over-the-air 802.11 captures replicates the
...
with surrogate-model transfer costing the attacker 11--23\,dB. We propose Minimum Effective Attack Power (MEAP) and
...
(8)~The real-capture study uses 96 gated bursts from four capture
...
still assume a perfect attacker channel.
